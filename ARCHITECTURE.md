...
S0262 is the first and highest-priority book under the descending-complexity work order; it remains active, and a second-ranked successor has not been selected or started. It exercises the large-scale LaTeX boundary against the permanent Stacks tag system: 116 source units, 14,994 nodes, 11 typed external theorems, 36,295 proof-use edges, and 11,284 candidate routes. Those edges consist of 36,037 explicit proof-xref edges and 258 owner-specific audited semantic edges: 71 named-result, 4 curated-claim, 12 external-citation, 109 deictic-proof, 25 recall-bundle, and 37 section-delegation dependencies. Its importer excludes examples, exercises, and ordinary remarks; promotes only eight exact-label theorem-level claims and ten proof-used definition/construction spans outside formal environments; separates explicitly alternate proofs into distinct routes; and retains 2,590 unresolved theorem-target references across 1,299 permanent tags plus 6 unresolved bibliographic proof citations. Another 1,892 theorem-like nodes remain dependency-pending. The candidate is reproducibly extracted, but it is not independently reviewed or complete.
