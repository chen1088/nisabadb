...
S0262 is the first and highest-priority book under the descending-complexity work order; it remains active, and a second-ranked successor has not been selected or started. It exercises the large-scale LaTeX boundary against the permanent Stacks tag system: 116 source units, 15,017 nodes, 11 typed external theorems, 36,350 proof-use edges, and 11,298 candidate routes. Those edges consist of 36,091 explicit proof-xref edges and 259 owner-specific audited semantic edges: 71 named-result, 5 curated-claim, 12 external-citation, 109 deictic-proof, 25 recall-bundle, and 37 section-delegation dependencies. Its importer excludes examples, exercises, and ordinary remarks; promotes only sixteen exact-label theorem-level claims and twenty-five proof-used assumption/definition/construction spans outside formal environments; separates explicitly alternate proofs into distinct routes; and retains 2,530 unresolved theorem-target references across 1,271 permanent tags plus 6 unresolved bibliographic proof citations. Another 1,886 theorem-like nodes remain dependency-pending. The candidate is reproducibly extracted, but it is not independently reviewed or complete.
