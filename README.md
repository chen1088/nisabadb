...
`S0262/complete-source.json` is the first dense-book checkpoint. It pins the official LaTeX source of *The Stacks Project* at tag-synchronized commit `ed88ff783bcb4dd9a28518a33b028841094009cf`, inventories all 116 chapters, and gives every included formal environment its permanent Stacks tag. The strict candidate graph contains 13,131 theorem-like nodes (12,587 lemmas, 330 propositions, and 214 theorems), 1,721 definitions, 124 formal situations/assumptions, 35,847 explicit proof-use edges, and 11,170 source or explicitly alternate proof routes. It contains zero example nodes: 449 example environments, 386 exercises, and 1,048 remark environments are explicitly excluded. Source-audited labels inside formal statements and proofs resolve to their formal owners; 2,807 remaining theorem-target records (1,333 unique permanent labels) and 30 bibliographic proof citations stay unresolved for later review instead of being smuggled in as examples or invented external results. The graph is extracted but not independently reviewed or complete; 1,998 theorem-like nodes still have no route with a resolved explicit formal proof reference.
