...
| Candidate theorem-like / support nodes | 13,519 / 2,036 |
| Candidate / reviewed source dependency edges | 36,368 / 0 |
...
The dense-book checkpoint is `S0262`, *The Stacks Project*. It is the first and highest-priority book under the descending-complexity work order; it remains the active target, and no second-ranked successor has been selected or started. The official LaTeX source is pinned at tag-synchronized commit `ed88ff783bcb4dd9a28518a33b028841094009cf`, because the later upstream head contains six new lemmas not yet assigned permanent Stacks tags. The importer inventories all 116 chapters and captures 14,994 nodes: 13,139 theorem-like nodes, 1,855 support nodes, and 11 typed external theorems. The theorem-like nodes comprise 12,587 lemmas, 330 propositions, 214 theorems, and 8 exact source-audited claims: six exact-label remarks, one labeled prose/display span, and the exact labeled Cauchy-Binet list item. Ten exact proof-used definition/construction spans are promoted as support nodes; all 449 example environments, 386 exercises, and the other 1,042 remark environments remain excluded. The graph has 36,295 proof-use edges and 11,284 candidate source or alternate proof routes. Its edges comprise 36,037 explicit proof-xref edges plus 258 exact owner-specific audited semantic edges (71 named-result, 4 curated-claim, 12 external-citation, 109 deictic, 25 occurrence-level recall-bundle, and 37 section-delegation dependencies). Exact audits suppress 3 notation/optional proof xrefs and 11 nondependency citations. It retains 2,590 unresolved theorem-target records across 1,299 unique permanent labels plus 6 bibliographic proof-citation records; 1,892 theorem-like nodes remain without a route containing a resolved candidate prerequisite. This is a reproducible extracted graph, not an independently reviewed or complete one.
